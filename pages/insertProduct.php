...
<html lang="pt" dir="ltr">
    ...
    <body>
        ...
        <main class="container-fluid d-flex flex-column justify-content-center align-items-md-center">
            <form 
                class="bg-white main__form d-flex flex-column jusify-content-evenly" method="POST" 
                enctype="multipart/form-data" action="../php/handlers/handleInsertProduct.php"
            >
                <?php
                if (!empty($_GET)):
                    ...
                    ?>
                        <div class="w-100 alert alert-success alert-dismissible fade show" role="alert">
                            <p class="m-0">O produto foi cadastrado com sucesso!</p>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    <?php elseif ($queryParam === 'insertProductError'): ?>
                ...
                <fieldset class="main__form-fieldset">
                    ...
                    <div class="mb-3 d-flex flex-column flex-md-row justify-content-evenly gap-md-2">
                        ...
                        <div class="w-100 mb-3 mb-lg-0">
                            ...
                            <input type="text" class="form-control" id="valor-input" name="valor-input" placeholder="R$ 0,00" required> 
                        </div>
                        
                        <div class="w-100 mb-3 mb-lg-0">
                            <label for="quantidade-input" class="form-label">Quantidade</label>
                            <input type="number" class="form-control" id="quantidade-input" name="quantidade-input" min="1" required> 
                        </div>
                    </div>
                    ...
                    <div class="mb-3 d-flex flex-column flex-md-row justify-content-evenly gap-md-2">
                        <div class="w-100 mb-3 mb-lg-0">
                            ...
                            <textarea type="text" class="form-control" id="descricao-input" name="descricao-input"></textarea> 
                        </div>
                    </div>
                    ...
                    <div class="mb-3 d-flex flex-column flex-md-row justify-content-evenly gap-md-2">
                        <div class="w-100 mb-3 mb-lg-0">
                            ...
                            <input type="file" class="form-control" id="imagem-input" name="imagem-input" required> 
                        </div>
                    </div>
