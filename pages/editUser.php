...
<html lang="pt" dir="ltr">
  ...
  <body>
    ...
    <main class="container-fluid d-flex flex-column justify-content-center align-items-md-center">
      <form class="bg-white main__form w-100 w-lg-50" method="POST" action="../php/handlers/handleUserUpdate.php?usr=<?php echo $_GET['usr']; ?>">
        <?php
        if(!empty($_GET)):
        ...
        <fieldset class="mb-3">
          ...
          <div class="mb-3 d-flex flex-column flex-md-row justify-content-evenly gap-md-2">
            ...
            <div class="w-100 mb-3 mb-lg-0">
                ...
                <input type="text" class="form-control" id="sobrenome-input" name="sobrenome-input" value="<?php echo $data['surname']; ?>" required> 
            </div>

            <div class="w-100 mb-3 mb-lg-0">
                <label for="status-input" class="form-label">Status</label>
                <select class="form-select" id="status-input" name="status-input" aria-label="Identificação de gênero">
                  <option value="none" selected>Selecione um status...</option>
                  <option value="admin" <?php echo $data['status'] === 'admin' ? 'selected' : ''; ?>>Administrador</option>
                  <option value="collab" <?php echo $data['status'] === 'collab' ? 'selected' : ''; ?>>Colaborador</option>
                  <option value="user" <?php echo $data['status'] === 'user' ? 'selected' : ''; ?>>Usuário</option>
                </select>
            </div>
          </div>
          ...
          <div class="mb-3 d-flex flex-column flex-md-row justify-content-evenly gap-md-2">
            <div class="w-100 mb-3 mb-lg-0">
                ...
                <input type="text" class="form-control" id="cpf-input" name="cpf-input" value="<?php echo $data['cpf']; ?>" required> 
            </div>
          ...
          <div class="mb-3 d-flex flex-column justify-content-evenly gap-2">
            <div class="w-100 mb-3 mb-lg-0">
                ...
                <input type="email" class="form-control" id="email-input" name="email-input" value="<?php echo $data['email']; ?>" required>
            </div>
        ...
        <fieldset class="mb-3">
          ...
          <div class="d-flex flex-column flex-lg-row">
            <div class="mb-3">      
                ...
                <input type="text" class="form-control" id="cep-input" name="cep-input" value="<?php echo $data['cep']; ?>" required>
            </div>
          </div>
          ...
          <div class="mb-3 d-flex flex-column flex-md-row justify-content-evenly gap-2">
            <div class="w-100">
                ...
                <input type="text" class="form-control" id="endereco-input" name="endereco-input" value="<?php echo $data['address']; ?>" required>
            </div>
            
            <div class="w-100">
                <label for="numero-input" class="form-label">Número</label>
                <input type="text" class="form-control" id="numero-input" name="numero-input" value="<?php echo $data['houseNumber']; ?>" required>
            </div>
          </div>
          ...
          <div class="mb-3 d-flex flex-column flex-md-row justify-content-evenly gap-2">
            <div class="w-100">
                ...
                <input type="text" class="form-control" id="cidade-input" name="cidade-input" value="<?php echo $data['city']; ?>" required>
            </div>
